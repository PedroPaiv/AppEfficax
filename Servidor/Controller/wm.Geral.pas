...
uses sm.Geral, Web.WebReq;

procedure TwmGeral.DSServerClass1GetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := sm.Geral.TsmGeral;
end;

procedure TwmGeral.DSAuthenticationManager1UserAuthenticate(
...
procedure TwmGeral.DSAuthenticationManager1UserAuthorize(
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := Sm.Geral.TsmGeral.ClassName
